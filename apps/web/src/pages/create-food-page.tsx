  ...
  return (
    <div className="max-w-md mx-auto px-4 py-12">
      ...
      <div className="bg-white rounded-3xl p-8 border border-brand-neutral-100 shadow-sm text-center flex flex-col items-center gap-4">
        ...
        <h1 className="font-display text-2xl font-bold text-brand-neutral-950">Pasang Makanan Baru</h1>
        <p className="text-sm text-brand-neutral-600 max-w-xs">
          Alur upload foto & auto-listing makanan berbasis AI sedang dipersiapkan dan akan selesai di Phase 5.
        </p>
